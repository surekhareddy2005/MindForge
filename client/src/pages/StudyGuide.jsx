              ...
              >
                {voiceInterviewOpen && (
                  <VoiceInterview
                    ...
                    topic={uploadId ? `Lecture ${uploadId.slice(-6)}` : 'Lecture Topic'}
                    onClose={() => setVoiceInterviewOpen(false)}
                  />
                )}
                          ...
                          return (
                            ...
                            >
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                                ...
                                {showResults && quizAnswers[qIdx] === undefined && (
                                  <span style={{
                                ...
                                {showResults && quizAnswers[qIdx] !== undefined && quizAnswers[qIdx] === quiz[currentQuizPage * itemsPerPage + qIdx]?.correct && (
                                  <span style={{
